...
class HomeworksControllerTest < ActionController::TestCase
  ...
  test "should create homework" do
    assert_difference('Homework.count') do
      post :create, homework: { due_date: @homework.due_date, title: @homework.title, user_id: @homework.user_id }
    end
  ...
  test "should update homework" do
    patch :update, id: @homework, homework: { due_date: @homework.due_date, title: @homework.title, user_id: @homework.user_id }
    assert_redirected_to homework_path(assigns(:homework))
  end
